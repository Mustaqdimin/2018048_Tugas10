package com.example.bab5_ryclycleview;
...
import com.example.bab5_ryclycleview.databinding.ActivityMain4Binding;
...
public class MainActivity4 extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        abdt = new ActionBarDrawerToggle(this, dl, R.string.Open,
                R.string.Close);
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull
                ...
                if (id == R.id.nav_chat) {
                    ...
                    Intent a = new
                            Intent(MainActivity4.this, MainActivity5.class);
                    startActivity(a);
                }
                return true;
            }
        ...
        public void parseJson(String data) throws JSONException {
            ...
            for (int i = 0; i < cityArray.length(); i++) {
                ...
                if (Sobj.equals(index)) {
                    ...
                    String name = obj.get("employee_name").toString();
                    binding.resultName.setText(name);
                    String salary =
                            obj.get("employee_salary").toString();
                    binding.resultSalary.setText(salary);
                    String age =
                            obj.get("employee_age").toString();
                    binding.resultAge.setText(age);
                    String profile =
                            obj.get("profile_name").toString();
                    binding.resultProfile.setText(profile);
                    break;
                } else {
