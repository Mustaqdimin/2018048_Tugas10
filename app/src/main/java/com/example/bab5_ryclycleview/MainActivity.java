...
import com.example.bab5_ryclycleview.databinding.ActivityMainBinding;
import com.example.bab5_ryclycleview.databinding.ActivityMainBinding;
import com.example.bab5_ryclycleview.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    String s1[], s2[],s3[];
    int images[] =
            {R.drawable.irlandi,R.drawable.yogi,R.drawable.sibli};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_chat){
                    ...
                    Intent a = new
                            Intent(MainActivity.this, MainActivity5.class);
                    startActivity(a);
                }
                return true;
            }
        ...
        s1 = getResources().getStringArray(R.array.Halodoc);
        s2 = getResources().getStringArray(R.array.Star);
        s3 = getResources().getStringArray(R.array.Deskripsi);
        HalodocAdapter appAdapter = new HalodocAdapter(this,s1,s2,s3,images);
