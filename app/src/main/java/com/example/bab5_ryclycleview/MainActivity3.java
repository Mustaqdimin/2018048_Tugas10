...
import static com.example.bab5_ryclycleview.DBmain.TABLENAME;
...
import com.example.bab5_ryclycleview.databinding.ActivityMain3Binding;
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_chat) {
                    ...
                    Intent a = new
                            Intent(MainActivity3.this, MainActivity5.class);
                    startActivity(a);
                }
                return true;
            }
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec = sqLiteDatabase.insert("doctor", null, cv);
                if (rec != null) {
